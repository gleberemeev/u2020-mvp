...
open class EnumAdapter<T : Enum<T>>
@JvmOverloads constructor(context: Context, enumType: Class<T?>,
                          private val showNull: Boolean = false) : BindableAdapter<T?>(context) {
    ...
    override fun bindView(item: T?, position: Int, view: View) {
        val tv = ButterKnife.findById<TextView>(view, android.R.id.text1)
